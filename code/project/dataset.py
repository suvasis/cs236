...
https://github.com/lukemelas/image-paragraph-captioning/blob/master/dataloader.py
"""
import warnings
...
class CaptionDataset(Dataset):
    ...
    def __init__(self, *, images_root: str, captions_path: str, text_transform: Optional[Callable] = None,
        ...
        #suvasis added
        self.captions.columns = ['image_file', 'caption']
        print(list(self.captions.columns))
...
if __name__ == "__main__":
    ...
    #images_root = './images'
    #captions_path = './images-list-clean.tsv'
    images_root = '/home/minasm/suvasis/tools/cs236_project/data/images'
    captions_path = '/home/minasm/suvasis/tools/cs236_project/data/cc12m/cc12m_clean_list.tsv'
